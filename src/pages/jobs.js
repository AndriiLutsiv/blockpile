...
export default function JobsPage({ posts, categories, totalPages, category, topSectionContent, bottomSectionContent, yoastSEO, error }) {
    console.log('posts', posts, 'categories', categories, 'totalPages', totalPages, 'category', category, 'topSectionContent', topSectionContent, 'bottomSectionContent', bottomSectionContent, 'error', error);
